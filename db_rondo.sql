...
INSERT INTO `admin_users` (`id`, `name`, `email`, `password_hash`, `role_id`, `role`, `status`, `permissions`, `last_login_at`, `password_changed_at`, `email_verified_at`, `two_fa_enabled`, `two_fa_secret`, `failed_login_attempts`, `locked_until`, `created_by`, `created_at`, `updated_at`) VALUES
	...
	(3, 'Administrator', 'admin@example.com', '$2y$10$nrSSAKGq92Tu2JKtKiCvMeRnGkgP/dVzIBGNlAZfQ7Lg7Lvw9IDHS', 1, 'super_admin', 'active', NULL, '2026-06-08 04:58:40', '2025-10-20 10:30:18', NULL, 0, NULL, 0, NULL, NULL, '2025-10-01 13:09:32', '2026-06-08 04:58:40'),
...
-- Dumping data for table rondo.contact_page_settings: ~0 rows (approximately)
...
-- Dumping data for table rondo.newsletter_subscriptions: ~1 rows (approximately)
...
-- Dumping data for table rondo.system_settings: ~26 rows (approximately)
...
-- Dumping data for table rondo.ticket_hospitalities: ~16 rows (approximately)
